...
class ProposalForm(forms.ModelForm):
    class Meta:
        model = Proposal
        fields = ['reference_number', 'customer', 'contact_name', 'contact_email', 'contact_phone', 'date', 'valid_until', 'subject', 'currency', 'exchange_rate', 'introduction', 'special_note', 'closing', 'tax_type', 'tax_rate', 'payment_terms', 'delivery_lead_time', 'warranty', 'cancellation_terms', 'include_bank_details']
        widgets = {
            ...
            'contact_name': forms.TextInput(attrs={'placeholder': 'Attention to', 'readonly': 'readonly'}),
            'contact_email': forms.EmailInput(attrs={'placeholder': 'Email', 'readonly': 'readonly'}),
            'contact_phone': forms.TextInput(attrs={'placeholder': 'Phone', 'readonly': 'readonly'}),
        }
